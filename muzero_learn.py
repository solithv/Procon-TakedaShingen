...
replay_buffer = ReplayBuffer(
    window_size=500,  # number of game store in the buffer
    batch_size=1,  # batch size is the number of observe game during train
...
mcts = Monte_carlo_tree_search(
    num_simulations=0,  # number of level (length of the tree )
...
epoch_pr, loss, reward, learning_config = learning_cycle(
    number_of_iteration=1000,  # number of epoch(step) in  muzero should be the |total amount of number_of_iteration x number_of_training_before_self_play|
